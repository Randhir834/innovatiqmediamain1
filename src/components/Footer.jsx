...
function Footer() {
  ...
  return (
    <>
      <Newsletter />
      <footer className="bg-gray-100 text-gray-900 py-8 sm:py-12 lg:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8 lg:gap-10 mb-8 sm:mb-10 lg:mb-12">
            {/* Company Info */}
            <div className="sm:col-span-2 lg:col-span-2">
              ...
              <div className="flex gap-3 sm:gap-4">
                <a 
                  ...
                  className="w-10 h-10 sm:w-12 sm:h-12 bg-white border border-gray-300 hover:bg-red-600 hover:border-red-600 hover:text-white text-gray-700 flex items-center justify-center transition-all duration-200 rounded shadow-sm" 
                  aria-label="Twitter"
                >
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li><a href="/" className="text-gray-400 hover:text-white transition-colors duration-200 text-xs sm:text-sm md:text-base">Home</a></li>
                <li><a href="/about" className="text-gray-400 hover:text-white transition-colors duration-200 text-xs sm:text-sm md:text-base">About Us</a></li>
                <li><a href="/contact" className="text-gray-400 hover:text-white transition-colors duration-200 text-xs sm:text-sm md:text-base">Contact</a></li>
              </ul>
            </div>
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li>
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-400 hover:text-white transition-colors duration-200 text-xs sm:text-sm md:text-base"
                  >
                    Services Portal
                  </a>
                </li>
                ...
                <li><a href="/about" className="text-gray-400 hover:text-white transition-colors duration-200 text-xs sm:text-sm md:text-base">Our Portfolio</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3 text-gray-400 text-xs sm:text-sm md:text-base">
                <li className="flex items-start gap-2">
                  ...
                  <a href="mailto:info@innovatiqmedia.com" className="hover:text-white transition-colors break-words">
          ...
          <div className="border-t border-gray-800 pt-6 sm:pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4">
              <p className="text-gray-400 text-center md:text-left text-xs sm:text-sm">
                &copy; 2026 InnovatiqMedia. All rights reserved.
              </p>
